...
-- 3) (Re-)opprett stage mot Azure Blob (ideelt burde man bruke storage integration med Azure AD, i stedet for å bruke azure sas token direkte slik jeg har gjort for å spare tid)
...
ALTER TASK RAW_STAGE_LOAD_TASK
  SUSPEND;
